...
<div class="row">
    <div class="col-lg-12">
      <ul class="nav nav-tabs">
        <li role="paket_wisata"><a href="<?=base_url() . 'paket_wisata';?>">Daftar</a></li>
        <li role="paket_wisata" class="active"><a href="<?=base_url() . 'paket_wisata/create';?>">Tambah</a></li>
      </ul>
    </div>
</div>
<!-- /.row -->
    ...
    <div class="col-lg-6">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          ...
          <a href="<?php echo base_url() . 'paket_wisata'; ?>" id="cancel" name="cancel" class="btn btn-danger">Cancel</a>
        </div>
      </div>
